...
export const alt = 'Balcony Solar News UK — Balcony Solar Guide'
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            The latest on UK plug-in solar regulation, products, and industry developments
          </p>
        </div>
