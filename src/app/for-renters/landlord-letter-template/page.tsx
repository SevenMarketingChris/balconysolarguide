      ...
      <div className="max-w-4xl mx-auto px-4 py-10">
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            <div className="border-l-4 border-solar-400 pl-4">
              <h3 className="font-semibold text-slate-900 mb-1">Emphasising portability upfront</h3>
              <p className="text-sm text-slate-600">
                Most landlord refusals stem from concern about permanent alterations or damage to the property. By
                establishing immediately that the system involves no structural changes and can be removed in minutes,
                you remove the primary objection before it can be raised.
              </p>
            </div>
            <div className="border-l-4 border-solar-400 pl-4">
              <h3 className="font-semibold text-slate-900 mb-1">Referencing G98 compliance</h3>
              <p className="text-sm text-slate-600">
                Mentioning G98 notification demonstrates that you understand the regulatory requirements and are
                acting responsibly. It reassures landlords who might be concerned about the legal status of balcony
                solar that you're approaching it correctly.
              </p>
            </div>
            <div className="border-l-4 border-solar-400 pl-4">
              <h3 className="font-semibold text-slate-900 mb-1">The Renters' Rights Act 2025 reference</h3>
              <p className="text-sm text-slate-600">
                Including a brief, non-confrontational reference to the Act signals that you know your rights — without
                being aggressive about it. Most landlords will read this as a prompt that unreasonable refusal has
                consequences, without feeling threatened.
              </p>
            </div>
            <div className="border-l-4 border-solar-400 pl-4">
              <h3 className="font-semibold text-slate-900 mb-1">Offering further documentation</h3>
              <p className="text-sm text-slate-600">
                Offering to provide product specs and G98 compliance docs signals that you've done your homework and
                are being transparent. It also gives the landlord an easy way to engage further if they want to, rather
        ...
        <section className="mb-10">
          ...
          <div className="space-y-3">
            <div className="border border-slate-200 rounded-lg p-4">
              <h3 className="font-semibold text-slate-900 mb-1">Ask for the reason in writing</h3>
              <p className="text-sm text-slate-600">
                A landlord who refuses should be able to explain why. Ask them to put their objection in writing.
                Vague refusals ("I don't want it") are more difficult to sustain if challenged. A written objection
                also gives you something concrete to address.
              </p>
            </div>
            <div className="border border-slate-200 rounded-lg p-4">
              <h3 className="font-semibold text-slate-900 mb-1">Propose a no-drill, freestanding alternative</h3>
              <p className="text-sm text-slate-600">
                If you haven't already specified a freestanding floor mount, propose this specifically. A system
                mounted on a freestanding stand — sitting on the balcony floor with no fixings at all — is even harder
                to refuse on reasonable grounds than a railing-clip mount.
              </p>
            </div>
            <div className="border border-slate-200 rounded-lg p-4">
              <h3 className="font-semibold text-slate-900 mb-1">Seek advice from Citizens Advice</h3>
              <p className="text-sm text-slate-600">
                Citizens Advice can advise on whether a refusal is reasonable under the Renters' Rights Act 2025 and
                what your options are. Their service is free and available online, by phone, and in local offices.
              </p>
            </div>
            <div className="border border-slate-200 rounded-lg p-4">
              <h3 className="font-semibold text-slate-900 mb-1">Formal dispute resolution</h3>
              <p className="text-sm text-slate-600">
                As a last resort, disputes about landlord consent under the Renters' Rights Act 2025 can be referred
                to the new Private Rented Sector Ombudsman (which came into operation following the Act). This is a
                free service. Your landlord is required by law to be registered with the Ombudsman scheme.
              </p>
            </div>
          </div>
        </section>
