...
export const alt = 'Jackery Navi 2000 Review — Balcony Solar Guide'
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Background glow top-right — muted gray tint */}
        <div
          style={{
            position: 'absolute',
            top: '-80px',
        ...
        >
          ...
          >
            German-market product — not sold in the UK
          </p>
        </div>
