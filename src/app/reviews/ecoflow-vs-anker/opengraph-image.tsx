...
export const alt = 'EcoFlow STREAM vs Anker SOLIX Comparison — Balcony Solar Guide'
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Background glow top-right — blue tint for comparison */}
        <div
          style={{
            position: 'absolute',
            top: '-80px',
        ...
        >
          ...
          >
            Head-to-head: the two best balcony solar systems
          </p>
        </div>
