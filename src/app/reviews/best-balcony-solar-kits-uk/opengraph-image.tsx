...
export const alt = 'Best Balcony Solar Kits UK — Balcony Solar Guide'
...
export default function Image() {
  return new ImageResponse(
    (
      ...
      >
        {/* Background glow top-right — green tint for roundup */}
        <div
          style={{
            position: 'absolute',
            top: '-80px',
        ...
        >
          ...
          >
            Top-rated plug-in solar kits for UK flats
          </p>
        </div>
